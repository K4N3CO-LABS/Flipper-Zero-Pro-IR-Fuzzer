...
## About
**The Pro IR Fuzzer** is a **custom**, **highly optimized standalone application** for the **Flipper Zero** that utilizes **bare-metal GPIO bit-banging** to execute **high-speed infrared** code sweeps across **multiple industrial protocol** standards.
